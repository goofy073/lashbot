...
func (h Handler) PaymentCallbackHandler(ctx context.Context, b *bot.Bot, update *models.Update) {
	...
	paymentURL, purchaseId, err := h.paymentService.CreatePurchase(ctx, float64(price), month, customer, invoiceType)
	if err != nil {
...
func (h Handler) SuccessPaymentHandler(ctx context.Context, b *bot.Bot, update *models.Update) {
	...
	err = h.paymentService.ProcessPurchaseById(ctx, int64(purchaseId))
	if err != nil {
